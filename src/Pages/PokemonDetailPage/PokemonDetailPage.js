...
import { BarraStats, Coluna1, Coluna1e2, Coluna2, Coluna3, DivBarraStats, DivTextoProgresso, DivTotal, H1, IdStyle, Img, Linha1, Linha2, MainCard, MainDiv, Moves, MovesH2, PokeCosta, PokeFrente, StatsH2, Texto, TextoStats, TitlePoke, Type1, Type2 } from "./pokemonDetailStyle";
                ...
                <MainCard color={color}>
                    <Coluna1e2>
                        ...
                        <Coluna2>
                            ...
                            <DivTotal>
                                <span>Total:</span>
                                <span>{detalhes?.stats?.reduce((a, b) => Number(a + b.base_stat), [])}</span>
                            </DivTotal>
                        </Coluna2>
                    </Coluna1e2>
                    <Coluna3>
